        ...
        <main className="container">
            ...
            <div className="row">
                <div className="col-md-12">
                    ...
                    <p>When I'm not developing websites, I spend my time knitting, playing tabletop games with my friends (virtually) and hanging out with my spaniel mix, Calvin.</p>
                </div>
            </div>
        </main>
    )
